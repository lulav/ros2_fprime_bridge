module spring {
  ...
  instance the_bridge: spring.ros2_bridge base id 0x0E00 \
    queue size Default.queueSize \
    stack size Default.stackSize 
  ...
  instance $health: Svc.Health base id 0x3000 \
    queue size 25 \
  {
  ...
  instance rateGroupDriverComp: Svc.RateGroupDriver base id 0x4600 {
    ...
    phase Fpp.ToCpp.Phases.configObjects """
    // shalev - assuming 100Hz cycle rate
    NATIVE_INT_TYPE rgDivs[Svc::RateGroupDriver::DIVIDER_SIZE] = { 100 };
    """
