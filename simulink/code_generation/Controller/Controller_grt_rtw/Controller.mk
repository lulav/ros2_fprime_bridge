...
## Generated on : Mon Nov 28 09:32:48 2022
...
START_DIR                 = /home/lulav/ros2_fprime_bridge/simulink/code_generation/Controller
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
DEFINES_STANDARD = -DMODEL=Controller -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
%.o : $(START_DIR)/Controller_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Controller_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Controller_data.o : $(START_DIR)/Controller_grt_rtw/Controller_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Controller_grt_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Controller_grt_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Controller_grt_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
