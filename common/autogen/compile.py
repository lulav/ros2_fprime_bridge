...
autogen_bp = f"// autogenerated by compile.py\n\n"
autogen_bp_fpp = f"# autogenerated by compile.py\n\n"

#------------------------------- parse headers --------------------------------

def find_type(line):
    """
        Return the variable type from a declaration line,
...
""".format(autogen_bp, str(version), g_input["schemas"]["proto"]["package"])
...
def write_fpp_boilerplate(fpp_file):
    fpp_file.write("{}module {} {{\n\n".format(autogen_bp_fpp, 
                                               g_input["schemas"]["fpp"]["module"]))
...
void proto2fpp({}::{}& {},
               {}::{}& {})
{{
""".format(autogen_bp, proto_ns, top_struct, proto_from, fpp_ns, top_struct, fpp_to)
...
void fpp2proto(const {}::{}& {},
               {}::{}& {})
{{
""".format(autogen_bp, fpp_ns, top_struct, fpp_from, proto_ns, top_struct, proto_to)
