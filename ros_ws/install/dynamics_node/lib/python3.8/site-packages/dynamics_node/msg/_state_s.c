...
bool dynamics_node__msg__state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dynamics_node.msg._state.State", full_classname_dest, 30) == 0);
  }
  dynamics_node__msg__State * ros_message = _ros_message;
  {  // r
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * dynamics_node__msg__state__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of State */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dynamics_node.msg._state");
  ...
  dynamics_node__msg__State * ros_message = (dynamics_node__msg__State *)raw_ros_message;
  {  // r
    PyObject * field = NULL;
