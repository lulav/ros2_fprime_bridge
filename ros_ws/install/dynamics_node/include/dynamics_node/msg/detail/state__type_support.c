...
#include <stddef.h>
#include "dynamics_node/msg/detail/state__rosidl_typesupport_introspection_c.h"
...
#include "dynamics_node/msg/detail/state__struct.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  dynamics_node__msg__State__init(message_memory);
}

void State__rosidl_typesupport_introspection_c__State_fini_function(void * message_memory)
{
  dynamics_node__msg__State__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember State__rosidl_typesupport_introspection_c__State_message_member_array[2] = {
  {
    ...
    offsetof(dynamics_node__msg__State, r),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dynamics_node__msg__State, v),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers State__rosidl_typesupport_introspection_c__State_message_members = {
  ...
  "State",  // message name
  2,  // number of fields
  sizeof(dynamics_node__msg__State),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dynamics_node, msg, State)() {
